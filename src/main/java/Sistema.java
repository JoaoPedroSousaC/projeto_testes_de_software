...
public class Sistema implements FuncionalidadesIF {
  ...
  public boolean ehTriangulo(double angulo1, double angulo2, double angulo3){
    ...
    double somaAngulosInternos = angulo1 + angulo2 + angulo3;
    if(somaDosAngulos != 180) return false;
    return true;
  }
  ...
  public boolean ehRetangulo(double lado1, double lado2, double lado3, double lado4){
    ...
    while(true){
      if(lados.size()==0) break;
      for(int i=1;i<lados.size();i++){
        if(lados.get(0).equals(0) || lados.get(i).equals(0)) return false;
  ...
  public String classificaTriangulo(double angulo1, double angulo2, double angulo3) {
    if(ehTriangulo(angulo1,angulo2,angulo3)){
      double[] arrayAngulos = {angulo1,angulo2,angulo3};
      if(ehTrianguloRetangulo(angulo1,angulo2,angulo3)) return "É um Triângulo Retângulo";
      if((angulo1 > 90)||(angulo2 > 90) || (angulo3 > 90)) return "É um Triângulo Obtusângulo";
      else return "É um Triângulo Acutângulo";
    }
    else return "Os Ângulos informados, não formam um triângulo!";
  }
  ...
  public double calculadora(String expressao){return 0;}
